  ...
  return (
    ...
    <MNavBar />
      ...
      <Box component="main" sx={{ flexGrow: 1, px: 4, py: 3, marginLeft: -8.4 }}>
        ...
        <Button className='referbtn1' style={{marginRight:'2rem'}} variant='contained' disabled>Refer Mentors</Button>
        <Button className='referbtn1' href='MentorReferAspirants' variant='contained'>Refer Aspirants</Button>
        <br />
        <br />
        <Typography className='converge' variant='h5'> Get upto Rs.XYZ for each mentor you invite to our platform</Typography>
        <br />
        ...
        <br />
        <br />
        <Typography className="converge" variant='h5'>OR</Typography>
        ...
        <div>
        <Typography className='converge'><b>Invite a MENTOR with your unique link</b></Typography>
        ...
        <br />
        <div style={{display:'flex'}}>
        <FactCheckIcon className='refericon' />
        <div>
        <Typography className='converge'><b>Invited MENTOR undergoes the Recruitment Process.</b></Typography>
        <Typography className='converge'>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummys</Typography>
        </div>
        </div>
